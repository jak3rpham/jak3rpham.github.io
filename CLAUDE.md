...
Two could apply → ask, do not guess (per the user's global CLAUDE.md).

**Why this rule exists:** on 2026-09-09 a Codex rebuild of the homepage beat Claude's. The gap
was not coding — Claude's machinery was more sophisticated (300-frame sequences, pinned
choreography). Codex read these same installed skills; Claude invoked none of them.
...
`C:\Users\jaker\.claude\projects\D--code-jak3rpham-github-io\memory\MEMORY.md`.
