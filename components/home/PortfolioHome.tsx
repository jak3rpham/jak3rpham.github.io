...
export function PortfolioHome() {
  ...
  return <main ref={root} className={s.home}><FlowGround /><ThemeFlow initial="dark">
    ...
    <section id="terra" data-zone="light" className={`${s.terra} ${s.section}`}>
      ...
      <div className={s.proof} data-reveal><div><span className={s.eyebrow}>From launch to momentum</span><strong>12×</strong><span>organic growth</span><strong className={s.health}>31.4M</strong><span>search impressions</span></div><div className={s.chart}><div><span>Organic search trajectory</span><span>22 months ↗</span></div><svg viewBox="0 0 600 180" role="img" aria-label="Illustrative trajectory of terra organic search growth"><path d={`${chart} L600,180 L0,180 Z`} fill="currentColor" opacity=".08" /><path className={s.chartLine} d={chart} fill="none" stroke="currentColor" strokeWidth="3" pathLength="1" /></svg><small>Monthly organic clicks · Search Console, Dec 2024 – Apr 2026 · 449,965 total, peak 66.3K in Mar 2026</small></div><div><strong>978</strong><span>keywords in the top 10</span><strong className={s.health}>55 → 90</strong><span>site health score</span></div></div>
